...
/* const createCliente =(clientes)=>{
    ...
    return (<>
        <form className="form d-flex justify-content-around flex-row p-3" action=""  onSubmit={onSubmit}>

            <input className="m-2" type="text" value={nombre} placeholder={"Cliente"} onChange={handleSubmitNombre}/>
            <input className="m-2" type="number" value={precio} placeholder={"Precio"} onChange={handleSubmitPrecio} />
            
                <select className="m-2" value={estado} name="estado" id="estado" onChange={handleSubmitEstado}>
            ...
            {modificar ? <div> <button className="btn m-1 btn-info" type="submit" value={id} onClick={modificarCliente}>Modificar</button> 
            <button className="btn m-1 btn-info" type="submit" value={id} onClick={cancelarModificacion}>Cancelar</button></div>:
             <button className="btn m-1 btn-info" type="submit" >Guardar</button>  
        }
        </form>
